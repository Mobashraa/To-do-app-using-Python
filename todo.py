...
if __name__ == "__main__" : 
	...
	# for typing the task 
	enterTaskField = Entry(gui, background="lightgreen")
	...
	# when user press the button, the command or 
	# function affiliated to that button is executed . 
	delete = Button(gui, text = "Delete", fg = "white", bg = "deeppink", command = delete)

	# create a Exit Button and place into the root window 
	# when user press the button, the command or 
	# function affiliated to that button is executed . 
	Exit = Button(gui, text = "Exit", fg = "white", bg = "red", command = exit)
